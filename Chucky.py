...
cl = LINETCR.LINE()
cl.login(token="EsMHfpTqDLeFMUfnCaI4.wOkmirNWe41AVCDdjgw/za.d4S276IdKgrn5hKkMjmwzbU0X7Y6kUI/duKIqktPFgY=")
cl.loginResult()
...
kk = LINETCR.LINE()
kk.login(token="EsTxc2IFdxFOTez64kF5.u0ANNHNbz+8A9tkOyStObq.A9jyzFZWSu0eKPSwk6d2PpWeRjRLUUjm0jb3Fy6Lf5I=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Es92e00BaoMHWMB2blV9.DoWKKaVjwh/naOep1ooa6q.o+UGYBw+75FAd4hkgTOx2coXrj9KjHvaR9to00QTuCc=")
kc.loginResult()

kr = LINETCR.LINE()
kr.login(token="EsycpG0Zx1Dc1UNluQ17.B1SXxj/vzd0tDPyYfa16jW.a11jwnp3XlBOHzadwbDtlrgyYIAmCkkDw7ojX6tIHbc=")
kr.loginResult()

km = LINETCR.LINE()
km.login(token="EsneELS8L1sBr4SMmKP8.9sY37/mZOkHTT1mJDPli2a.e1QMvmg/dSUUgQK0QEkcaL577mlfXFSmrSpQQHxwtE0=")
km.loginResult()
...
def sendImage(self, to_, path):
      ...
      M.contentMetadata = None
      M.contentPreview = None
      M2 = self._client.sendMessag-e(0,M)
      M_id = M2.id
      files = {
         'file': open(path, 'rb'),
      }
...
BUKAN SULAP, BUKAN SIHIR BUKAN 
KICKER, BUKAN HACKER JARI GW GA 
SENGAJA KEPELINTIR ┌∩┐(◣_◢)┌∩┐ KZL??? 
━━━━━┒ MAMPOS LO! ┓┏┓┏┓┃ 
┛┗┛┗┛┃＼(-_-)／ ┓┏┓┏┓┃ / ┛┗┛┗┛┃ ノ) 
┓┏┓┏┓┃ ┛┗┛┗┛┃ ┓┏┓┏┓┃ ┛┗┛┗┛┃ ┓┏┓┏┓┃ 
┃┃┃┃┃┃ ┻┻┻┻┻┻ SORRY YA MBLO. BUKAN GW 
YANG SALAH. SALAHIN JARI² GW YANG 
LAGI GABUT :v ☁☁🌞 ☁ ☁
       ☁ ✈ ☁ 🚁 ☁ ☁ ☁ ☁ ☁ 
🏬🏨🏫🏢🏤🏥🏦🏪🏫
              🌲/ l🚍\🌳👭
...
________◥▓█k倫KACANG倫█▓◤ 
C________◥▓█倫KACANG倫█▓◤ 
__________◥▓█倫KACANG RIP YOUR GRUP, 
JANGAN MACEM² YA MBLOO, ULAH LU KAYAK 
ALAY!!! 
😎😎😎😎😎😎😎😎😎😎😎😎😎😎😎😎😎😎
>>>>>>>>>> G O O D B Y E
😂😂😂😂😂😂😂😂😂😂😂😂😂😂😂😂😂😂
...
TANGKISSS ANJING TANGKISSSS SEBELUM 
RUANG KOSONG!!!!!
 ¸.¤*¨¨*¤.¸¸...¸..¤\ \ 
¸.¤*'``*¤.,,..,...¤ \
  \ ¸ LEMAH \
  ...
  /▌ \
  / \ ████.RATA GAK RATA YG ╬╬. 
PENTING PERNAH ╬╬ ADA ╬╬.  . ╬╬ ╬╬\O 
╬╬ ▌\~ RATA YA ╬╬// KAMI SENANG~ ╬╬ 
╬╬ ╬╬ ╬╬ ╬╬ ╬╬\O ~GAK RATA ╬╬/▌LU 
BERUNTUNG~ ╬╬/.\ █████ KIBARKAN 
BENDERA KEMATIAN FUCK YOU GRUP 
……..…../´¯/)……….. (\¯`\ 
…………/….//……….. …\\….\ ………../….//………… 
….\\….\ …../´¯/…./´¯\………../¯ `\….\¯`\ 
.././…/…./…./.|_……_| .\….\….\…\.\.. 
...
..\…………….. /……..\……………..…/ 
….\…………..(………. ..)……………./ RATA GK 
RATA BODO AMAT YG PENTING PERNAH 
MAMPIR DIGIDAW RATA KAMI SENANG GK 
RATA KAMI JUGA SENANG YG PENTING KAMI 
PERNAH MAMPIR DIGIDAW SATPAM NYA 
LEMAH!! MEMBERNYA PADA CUPU!! DUA 
TIGA TUTUP BOTOL TANGKIS KAMI KALO 
BISA TONGKOL
                       /¯ )
                     /¯ /
                   / /
...
TANGKIS JANGAN DIEM SAYANG!!! SATPAM 
NYA LEMAH MEMBERNYA PADA CUPU IN 
ACTION .._|\______________________,, 
../ 
`--||||||||-------------------------] 
./_==◎______________|-------/ 
...),----.(_(__) / ..//(¤) / ),----"" 
...
║║║║║║║╠╗╔╣║║║║║║║ ║║║║╦║║║║║║╦║╔╬╬╬╣ 
╚╩╩╩╩╩╩╝╚╝╚╩╩╝╚╩╩╝ Yah malah diliatin 
TANGKIS GOBLOK ini bagus kgk bro 
JANGAN KANGEN YAH 😚😚😚 
▓▓▓▓▓▓▓▓▓▓▓▓▓ ▓▓▓▒▒▓▓▓▒▒▓▓▓ 
▓▓▓▒▒▓▓▒▒▓▓▓▓ ▓▓▓▒▒▓▒▒▓▓▓▓▓ 
▓▓▓▒▒▒▒▓▓▓▓▓▓ ▓▓▓▒▒▒▒▓▓▓▓▓▓ 
